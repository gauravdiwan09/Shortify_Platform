          ...
          <Col lg={8}>
            <div className="developer-profile">
              ...
              <p className="lead text-muted mb-4">
                ...
                As a tech enthusiast, I am always looking for opportunities to expand my horizons. I am eager to explore different domains and connect with professionals.
              </p>
